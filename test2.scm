;; Mostly Nils Holm's Prolog in 6 Slides code with a few alterations to make it easier to transpile.
;; This file should run in mit-scheme.

;; dumbed down to r5rs for Apple Silicon
;brew install gambit-scheme
;scheme-r5rs
;(load "prolog-r5rs.scm")
        ...
        (let ((e* (unify (car a) (car g) e)))
          (if e*
              (prove6 (link l g r e n c)
                      ...
                      (AppendInefficient3 (cdr a) (list (quote r!) l) (cdr g))
                      whole-db
                      e*
                      (+ 1 n)
                      l
